...
"""Client-stub payload test for WhistleBlowerWreck.
...
def test_client_stub_whistleblowerwreck_preserves_sprint4_identity() -> None:
...
def test_client_stub_whistleblowerwreck_has_action_plan() -> None:
    payload = build_payload()
