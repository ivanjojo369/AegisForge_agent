...
"""Client-stub payload test for StaticShipScam.
...
def test_client_stub_staticshipscam_preserves_sprint4_identity() -> None:
...
def test_client_stub_staticshipscam_has_action_plan() -> None:
    payload = build_payload()
