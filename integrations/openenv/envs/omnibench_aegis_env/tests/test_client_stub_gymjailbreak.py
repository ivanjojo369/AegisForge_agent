...
"""Client-stub payload test for GymJailbreak.
...
def test_client_stub_gymjailbreak_preserves_sprint4_identity() -> None:
...
def test_client_stub_gymjailbreak_has_action_plan() -> None:
    payload = build_payload()
