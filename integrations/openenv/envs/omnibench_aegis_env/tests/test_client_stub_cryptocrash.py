...
"""Client-stub payload test for CryptoCrash.
...
def test_client_stub_cryptocrash_preserves_sprint4_identity() -> None:
...
def test_client_stub_cryptocrash_has_action_plan() -> None:
    payload = build_payload()
